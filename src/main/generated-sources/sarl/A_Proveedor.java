...
public class A_Proveedor extends Agent {
  ...
  private double precioDeliver = 10.0;
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    this.precioDeliver = 15.0;
    double factorPrecio = Math.random();
    int precioBaseProducto = 10;
  ...
  protected void ComprobarExistencias(final Integer codProd_Aux) {
    for (final Producto x : this.listaProductos) {
      ...
      if ((codProd_Aux == null ? (_codigo == null) : (_codigo != null && codProd_Aux.intValue() == _codigo.doubleValue()))) {
        DefaultContextInteractions _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER = this.$castSkill(DefaultContextInteractions.class, (this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS == null || this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS = this.$getSkill(DefaultContextInteractions.class)) : this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS);
        Integer _stock = x.getStock();
        InformarExistencias _informarExistencias = new InformarExistencias(codProd_Aux, Boolean.valueOf((_stock.intValue() > 0)));
        _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER.emit(_informarExistencias);
      }
    }
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    A_Proveedor other = (A_Proveedor) obj;
    if (Double.doubleToLongBits(other.precioDeliver) != Double.doubleToLongBits(this.precioDeliver))
      return false;
  ...
  public int hashCode() {
    ...
    final int prime = 31;
    result = prime * result + (int) (Double.doubleToLongBits(this.precioDeliver) ^ (Double.doubleToLongBits(this.precioDeliver) >>> 32));
    return result;
  }
  
  @SyntheticMember
  public A_Proveedor(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public A_Proveedor(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public A_Proveedor(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
