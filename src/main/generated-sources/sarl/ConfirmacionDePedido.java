...
public class ConfirmacionDePedido extends Event {
  public Integer codigoProducto;
  
  public ConfirmacionDePedido(final Integer v) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ConfirmacionDePedido other = (ConfirmacionDePedido) obj;
  ...
  /**
   * Returns a String representation of the ConfirmacionDePedido event's attributes only.
   */
  @SyntheticMember
  @Pure
